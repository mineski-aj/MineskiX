...
const state = {
  ...
  // html/LowerThirds.html — Map Selection tag. revealedGames = how many games'
  ...
  draftRealmeActive: false, // whether Draft-realme.html (realme-skinned pick/ban overlay) is currently shown
